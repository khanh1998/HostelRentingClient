    ...
    <v-row class="white my-5">
      <v-col cols="12" class="py-0">
        <v-row class="ma-0">
          ...
          <v-col cols="2" class="pr-0">
            <span class="field-name font-weight-medium">Tổng số giường </span>
            <v-text-field
          ...
          <v-col cols="2" class="px-0">
            <span class="field-name font-weight-medium">Giường trống </span>
            <v-text-field
              class="size-sub light-autocomplete font-nunito"
              color="#727cf5"
              outlined
            ...
            <v-col cols="4" :key="i" v-for="(item, i) in type.rooms">
              ...
              >
                <v-row class="d-flex align-start ma-0 pr-0">
                  ...
                  <v-col cols="10">
                    <span class="field-name font-weight-medium ml-2">Tên giường</span>
      ...
      <v-col cols="12" v-if="type.rooms.length === 0" class="pt-0 pb-2 pl-6">
        <v-card
          ...
          style="box-shadow: none !important; border: thin solid rgba(0, 0, 0, 0.12)"
        >
          <span class="mt-8">Không có giường</span>
        </v-card>
      </v-col>
