  ...
  <div>
    ...
    >
      ...
      <v-col cols="2" class="d-flex align-center pt-2 pb-1">
        <span class="font-nunito text-gray size-sub-2"> {{ renter.phone }} </span>
      </v-col>
      ...
      <v-col cols="2" class="d-flex align-center justify-center pt-2 pb-1">
        <span class="font-nunito text-gray size-sub-2">
          <v-chip class="ma-2" color="yellow darken-1" text-color="white" v-if="!renter.censored">
            Chưa kiểm duyệt
          </v-chip>
          <v-chip class="ma-2" color="green" text-color="white" v-if="renter.censored">
            Đã kiểm duyệt
          </v-chip>
        </span>
      </v-col>
          ...
          <v-row>
            <v-col cols="12" md="3" class="pt-10">
              <div class="d-flex flex-column justify-center align-center">
                <v-avatar size="128" class="pb-3" v-if="renter.avatar !== null">
            ...
            <v-col cols="12" md="9" style="border-left: 1px solid lightgray" class="mt-3 pa-0 py-0">
              <v-row no-gutters class="hidden-sm-and-down">
                      ...
                      <v-row no-gutters>
                        <v-col cols="4" class="d-flex justify-start">
                          <v-card-text
                            ...
                            >{{ renter.role === 'RENTER' ? 'Khách thuê' : '' }}
                            {{ renter.role === 'VENDOR' ? 'Chủ trọ' : '' }}</v-card-text
                          >
                        </v-col>
                      ...
                      <v-row no-gutters>
                        ...
                        <v-col cols="8" class="d-flex justify-start">
                          <v-card-text
                            style="font-size: 16px"
                            class="font-weight-bold pa-0 py-0 pt-2 pb-2"
                            >{{ renter.yearOfBirth }}</v-card-text
                          >
                        </v-col>
                      </v-row>
                    </v-col>
                      ...
                      <v-row no-gutters>
                        ...
                        <v-col cols="8" class="d-flex justify-start">
                          <v-card-text
                            style="font-size: 16px"
                            class="font-weight-bold pa-0 py-0 pt-2 pb-2"
                            >{{ renter.hometown.provinceName }}</v-card-text
                          >
                        </v-col>
                      </v-row>
                    </v-col>
                      ...
                      <v-row no-gutters>
                        ...
                        <v-col cols="8" class="d-flex justify-start">
                          <v-card-text
                            style="font-size: 16px"
                            class="font-weight-bold pa-0 py-0 pt-2 pb-2"
                            >{{ renter.school.schoolName }}</v-card-text
                          >
                        </v-col>
                      </v-row>
                    </v-col>
                      ...
                      <v-row no-gutters>
                        ...
                        <v-col cols="8" class="d-flex justify-start">
                          <v-card-text
                            style="font-size: 16px"
                            class="font-weight-bold pa-0 py-0 pt-2 pb-2"
                            >{{ renter.citizenIdNum }}</v-card-text
                          >
                        </v-col>
                      </v-row>
                    </v-col>
                      ...
                      <v-row no-gutters>
                        ...
                        <v-col cols="8" class="d-flex justify-start">
                          <v-card-text
                            style="font-size: 16px"
                            class="font-weight-bold pa-0 py-0 pt-2 pb-2"
                            >{{ renter.idIssuedLocation }}</v-card-text
                          >
                        </v-col>
                      </v-row>
                    </v-col>
                      ...
                      <v-row no-gutters>
                        ...
                        <v-col cols="8" class="d-flex justify-start">
                          <v-card-text
                            ...
                            class="font-weight-bold pa-0 py-0 pt-2 pb-2"
                            >{{
                              new Date(renter.idIssuedDate).toLocaleDateString('vi')
                            }}</v-card-text
                          >
                        </v-col>
                      </v-row>
                      ...
                      <v-row no-gutters>
                        ...
                        <v-col cols="8" class="d-flex justify-start">
                          <v-card-text
                            style="font-size: 16px"
                            class="font-weight-bold pa-0 py-0 pt-2 pb-2"
                            >{{ renter.householdAddress }}</v-card-text
                          >
                        </v-col>
                      </v-row>
                    </v-col>
                      ...
                      <v-row no-gutters>
                        ...
                        <v-col cols="8" class="d-flex justify-start">
                          <v-card-text
                            style="font-size: 16px"
                            class="font-weight-bold pa-0 py-0 pt-2 pb-2"
                            >{{ renter.currentAddress }}</v-card-text
                          >
                        </v-col>
                      </v-row>
                    </v-col>
                    ...
                    <v-col cols="6">
                      <v-row no-gutters>
                        ...
                        <v-col cols="12">
                          ...
                          >
                            <p v-if="!renter.citizenIdFrontImg" class="d-flex justify-center">
                              Thiếu ảnh
                            </p>
                            <v-img
                              height="240"
                              width="260"
                              v-if="renter.citizenIdFrontImg"
                              :src="renter.citizenIdFrontImg"
                            >
                      ...
                      <v-row no-gutters>
                        ...
                        <v-col cols="12">
                          <v-card-text
                            ...
                            class="font-weight-bold pa-0 py-0 pt-2 pb-2 d-flex justify-center pl-3 pr-3"
                          >
                            <p v-if="!renter.citizenIdBackImg" class="d-flex justify-center">
                              Thiếu ảnh
                            </p>
                            <v-img
                              height="240"
                              width="260"
                              v-if="renter.citizenIdBackImg"
                              :src="renter.citizenIdBackImg"
                            >
                              <template v-slot:placeholder>
                                <v-row class="fill-height ma-0" align="center" justify="center">
                                  <v-progress-circular
                ...
                <v-col cols="12" class="d-flex justify-end pr-9 pb-5 pt-5">
                  <v-btn @click="confirmedCensoredVendor()" color="#727CF5" dark v-if="!renter.censored">
                    <v-icon left>verified_user</v-icon> Kiểm duyệt
                  </v-btn>
                  <v-btn @click="unConfirmedCensoredVendor()" color="#727CF5" dark v-if="renter.censored">
    ...
    <v-dialog v-model="showBlockDiaglog" persistent max-width="290">
      <v-card>
        ...
        <v-card-text class="font-nunito d-flex justify-center font-weight-bold mt-4" style="font-size: 1.125rem !important">{{renter.username}}</v-card-text>
        <v-card-actions class="d-flex justify-center">
...
export default {
  name: 'RenterItem',
  props: { renter: Object, index: Number },
  ...
  data: () => ({
    ...
    newUser: {
      ...
      data: {
        ...
        avatar: null,
        currentAddress: null,
        citizenIdFrontImg: null,
        citizenIdNum: null,
        citizenIdBackImg: null,
        idIssuedLocation: null,
        yearOfBirth: null,
        email: null,
        idIssuedDate: null,
  ...
  methods: {
    ...mapActions({
      ...
      updateUser: 'user/updateRenterV2',
    }),
    closeDetailDialog() {
      this.showDetailDiaglog = false;
    },
    censoredVendor() {
      this.newUser.data.blocked = this.renter.blocked;
      this.newUser.data.censored = true;
      this.newUser.userId = this.renter.userId;
      this.newUser.data.school = this.renter.school;
      this.newUser.data.hometown = this.renter.hometown;
      this.newUser.data.avatar = this.renter.avatar;
      this.newUser.data.currentAddress = this.renter.currentAddress;
      this.newUser.data.citizenIdFrontImg = this.renter.citizenIdFrontImg;
      this.newUser.data.citizenIdNum = this.renter.citizenIdNum;
      this.newUser.data.citizenIdBackImg = this.renter.citizenIdBackImg;
      this.newUser.data.idIssuedLocation = this.renter.idIssuedLocation;
      this.newUser.data.yearOfBirth = this.renter.yearOfBirth;
      this.newUser.data.email = this.renter.email;
      this.newUser.data.idIssuedDate = this.renter.idIssuedDate;
      this.newUser.data.householdAddress = this.renter.householdAddress;
    ...
    blockedVendor() {
      ...
      this.newUser.data.censored = this.renter.censored;
      this.newUser.userId = this.renter.userId;
      this.newUser.data.school = this.renter.school;
      this.newUser.data.hometown = this.renter.hometown;
      this.newUser.data.avatar = this.renter.avatar;
