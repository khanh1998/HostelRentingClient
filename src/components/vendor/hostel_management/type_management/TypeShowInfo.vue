...
export default {
  ...
  props: { type: Object, group: Object, showCreateType: Boolean },
  computed: {
    groups() {
    ...
    newTypeValue() {
      //   const newTypeData = this.$store.state.vendor.group.createType.data;
      const { typePrice, typePriceUnit } = this.getPriceUnitShow(
        this.type.price,
        this.type.priceUnit,
      );
      const newTypeData = {
        ...
        superficiality: this.type.superficiality,
