  ...
  computed: {
    ...
    showCreateTypeDialog() {
      ...
      if (this.showCreateType) {
        if (this.groupSelected.length > 0 && this.typeSelected.length > 0) {
          return this.showCreateType;
        }
        return this.showChooseExistTypeDialog;
      }
  ...
  methods: {
    ...
    insertNewType() {
      ...
      if (
        ...
        const { typePrice, typePriceUnit } = this.getPriceUnit(this.newTypeValue.price, this.newTypeValue.priceUnit);
        // if (this.showChooseExistTypeDialog) {
