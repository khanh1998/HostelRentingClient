<template>
  <v-card class="ml-16 d-flex flex-md-row flex-column">
        ...
        <v-list>
          <v-dialog v-model="nameDialog.show" max-width="400px">
            ...
            <v-card class="pa-2">
              ...
              <v-text-field placeholder="Tên mới" v-model="groupUp.groupName"  class="ma-3"></v-text-field>
              <v-card-actions class="d-flex justify-center">
                <v-btn color="grey darken-1" text @click="nameDialog.show = false">
                  Hủy
                </v-btn>
                <v-btn color="green darken-1" text @click="nameDialog.show = false; updateHostelGroup()">
                  Đổi tên
                </v-btn>
              </v-card-actions>
            </v-card>
          ...
          >
            ...
            <v-toolbar dark color="#727CF5">
              ...
              <v-spacer></v-spacer>
              <v-toolbar-items>
                <v-btn dark text @click="serviceDialog.show = false; updateService()">
          ...
          >
            ...
            <v-toolbar dark color="#727CF5">
              ...
              <v-spacer></v-spacer>
              <v-toolbar-items>
                <v-btn dark text @click="typeDialog.show = false; createType()">
                  ...
                  <div class="hidden-sm-and-up">
                    <v-col cols="12" sm="4">
                      ...
                      <span class="text-h6"><v-icon>info</v-icon> Thông tin cơ bản</span>
                                <v-text-field v-model="type.title" hide-details prefix="Tên loại phòng:" prepend-icon="closed_caption" />
                                <v-text-field
                                  type="number"
                                  v-model="type.price"
                                  prefix="Giá:"
                    ...
                    <v-col cols="12" sm="4">
                      ...
                      <div class="d-flex flex-row flex-wrap align-center justify-center">
                                  ...
                                  <span class="text-h6" v-if="this.upload.imageUrls && this.upload.imageUrls.length > 0"
    ...
    <v-card-actions class="d-flex flex-row flex-wrap" v-if="!isMobile">
      ...
      >
        <template v-slot:activator="{ on, attrs }">
          <v-btn depressed outlined rounded class="ma-1" color="amber" small v-on="on" v-bind="attrs">
        <v-icon left>add</v-icon>
        Tạo nhà trọ mới
      </v-btn>
        </template>
